...
prompt = f'''
I am teaching web development using Sigma Web Development couse. Here are vioe chunks with video title, video number, start seconds of the chunk. end seconds of the chunk , and the text at that time:
